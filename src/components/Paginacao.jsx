      ...
      <div className="box-footer clearfix">
        ...
        <div className="col-xs-12 col-md-8">
          <ul className="pagination pull-right">
            <li
              className={paginaAtual === 0 ? "page-item disabled" : "page-item"}
            >
              <button
                onClick={() => renderPrevPagina()}
            ...
            >
              <button
                onClick={() => renderPrimeiraPagina(paginaAtual)}
                className="page-link btn btn-sm"
              >
            ...
            {pages.map((pagina) => {
              return (
                <li>
                  <a
                    onClick={() => renderPaginaCorrente(pagina)}
                    className="page-link"
                  >
                    {pagina}
                  </a>
            ...
            <li className={paginaAtual === paginaFim ? "page-item disabled" : "page-item"}>
              <button
                onClick={() => renderProximaPagina(paginaAtual)}
                className="page-link btn btn-sm">
            ...
            <li className={paginaAtual === paginaFim ? "page-item disabled" : "page-item"}>
              <button
                onClick={() => renderUltimaPagina(paginaAtual)}
                className="page-link btn btn-sm">
                Ultima
              </button>
            </li>
